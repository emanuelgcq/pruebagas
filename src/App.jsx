...
import { Users, Building2, Smartphone, Truck, Calculator, Route } from "lucide-react";
import {
...
import { crearAsignacionesIniciales } from "./distribucionSeed.js";
...
export default function App() {
  ...
  const [rutasDistribucion, setRutasDistribucion] = useState(() => crearAsignacionesIniciales());
      ...
      <div className="switcher">
        ...
        <div className="sw-hint">
          {cara === "proyecto" ? "Resumen del proyecto · problemas, solución y accesos"
            ...
            : cara === "ops" ? "Viendo como conductor · ruta asignada por Distribución"
