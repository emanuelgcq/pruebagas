...
import { cilindrosFila, unidadDistribucion } from "./distribucionSeed.js";
    ...
    <div className="pj">
      ...
      <section className="pj-section pj-soft">
        ...
        <div className="pj-problems">
          <Problema icon={Route} problema="La logística se arma hoy en Excel y se reporta por WhatsApp" solucion="Distribución recibe los pedidos individuales en una bandeja central. Puede crear una jornada comunal o seleccionar cualquier conjunto de pedidos Sin AD para una AD personalizada, asignando ruta, placa y operador identificado." />
      ...
      <section className="pj-section pj-soft">
        <div className="pj-title"><span>03</span><div><h2>Distribución · centro de la logística operativa</h2><p>La planificación nace de una bandeja individual de pedidos. Distribución puede agrupar por comuna o crear una AD personalizada seleccionando pedidos concretos, con control especial para solicitudes sin pago.</p></div></div>
        <div className="pj-two">
          <article className="pj-module">
            <div className="pj-module-icon"><Route size={22}/></div>
            <div className="pj-kicker">MÓDULO DE DISTRIBUCIÓN</div>
            <h2>Del Excel y WhatsApp a una planificación única y trazable.</h2>
            <ul>
              <li><CheckCircle2/> Planificación diaria por zona, ruta, comuna, comunidad y tamaños 10/18/27/43 kg.</li>
              <li><CheckCircle2/> Distribución selecciona el vehículo por placa y un operador real identificado por nombre y cédula; el conductor nunca escoge la ruta en la app.</li>
              <li><CheckCircle2/> Desde Pedidos en tiempo real se pueden marcar solicitudes Sin AD y crear una AD personalizada, incluso con varias comunidades; los no pagados requieren modalidad autorizada y justificación.</li>
              <li><CheckCircle2/> Fuerza propia y EPSDC se identifican desde la unidad asignada, con sus porcentajes y totales.</li>
              <li><CheckCircle2/> El detalle conserva una fila por persona para saber quién pagó y quién entra realmente al AD, aunque la entrega residencial sea a la comuna.</li>
              <li><CheckCircle2/> Reporte diario corto para WhatsApp generado desde la misma planificación, sin volver a transcribir cifras.</li>
            </ul>
          ...
          <article className="pj-module comuna">
            ...
            <div className="pj-kicker">DATA COMPARTIDA</div>
            <h2>{num(rutasDistribucion.reduce((a,r)=>a+cilindrosFila(r),0))} cilindros en la planificación 14-08-2026.</h2>
            <ul>
              <li><CheckCircle2/> {num(rutasDistribucion.filter(r=>unidadDistribucion(r.unidad).tipo === "FUERZA_PROPIA").reduce((a,r)=>a+cilindrosFila(r),0))} cilindros asignados a fuerza propia.</li>
              <li><CheckCircle2/> {num(rutasDistribucion.filter(r=>unidadDistribucion(r.unidad).tipo === "EPSDC").reduce((a,r)=>a+cilindrosFila(r),0))} cilindros asignados a EPSDC.</li>
              <li><CheckCircle2/> Comercialización ve esta misma planificación como vista espejo; no existe otra carga paralela.</li>
              <li><CheckCircle2/> Operaciones recibe únicamente las AD asignadas al operador y al vehículo definidos por Distribución.</li>
            </ul>
          </article>
        </div>
      </section>
      ...
      <section className="pj-section pj-soft">
        <div className="pj-title"><span>05</span><div><h2>Acceso a los portales del prototipo</h2><p>Cada vista representa un rol distinto dentro del mismo flujo y comparte los mismos datos.</p></div></div>
