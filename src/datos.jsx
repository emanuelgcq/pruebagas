...
export const HOY = new Date(2026, 7, 14);
...
export const fecha = (d) => { const v = fechaValida(d); return v ? v.toLocaleDateString("es-VE", { day: "2-digit", month: "2-digit", year: "numeric" }) : "—"; };
export const fechaGuion = (d) => { const v = fechaValida(d); return v ? `${String(v.getDate()).padStart(2, "0")}-${String(v.getMonth() + 1).padStart(2, "0")}-${v.getFullYear()}` : "—"; };
export const fechaCorta = (d) => { const v = fechaValida(d); return v ? v.toLocaleDateString("es-VE", { day: "2-digit", month: "2-digit" }) : "—"; };
export const mesCorto = (d) => { const v = fechaValida(d); return v ? v.toLocaleDateString("es-VE", { day: "2-digit", month: "short" }) : "—"; };
export const fechaLarga = (d) => { const v = fechaValida(d); return v ? v.toLocaleDateString("es-VE", { day: "numeric", month: "long", year: "numeric" }) : "—"; };
